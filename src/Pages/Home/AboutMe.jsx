    ...
    <section id="AboutMe" className="about--section">
      ...
      <div className="hero--section--content--box about--section--box">
        <div className="hero--section--content">
          ...
          I am a sophomore at the University of Texas at Dallas majoring in Computer Science. I am passionate and driven in learning new things and applying concepts that I learn into software solutions, whether if it's a side project or a hackathon.
          </p>
          <p className="hero--section-description about--description" style={{color:'#fff'}}>
